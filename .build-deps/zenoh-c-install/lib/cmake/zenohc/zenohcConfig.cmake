...
if(NOT TARGET __zenohc_shared)
    ...
    if(NOT ("zenohc.dll.lib" STREQUAL ""))
        set_property(TARGET __zenohc_shared PROPERTY IMPORTED_IMPLIB "${PACKAGE_PREFIX_DIR}/lib/zenohc.dll.lib")
    endif()
endif()
if(NOT TARGET __zenohc_static)
    ...
    set_target_properties(__zenohc_static PROPERTIES
        IMPORTED_LOCATION "${PACKAGE_PREFIX_DIR}/lib/zenohc.lib"
        INTERFACE_INCLUDE_DIRECTORIES "${PACKAGE_PREFIX_DIR}/include"
    )
endif()
