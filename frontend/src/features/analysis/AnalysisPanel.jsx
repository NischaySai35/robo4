/**
 * AnalysisPanel — static engineering readout (Phase 8): total mass, center of
 * mass, and per-joint gravity-holding torque + estimated ST3215 current, with a
 * toggle for the 3D overlay (COM marker + joint load heatmap). Overloaded joints
 * (torque beyond the servo's stall) are flagged red.
 */
...
import { jointLoads, centerOfMass, ST3215 } from '@/kinematics/analysis.js';
