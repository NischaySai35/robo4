...
import { buildSerialArmEntities } from '@/features/ai/aiActions.js';
...
function findEntity(doc, kind, key) {
...
function primitive(type, opts = {}, doc) {
...
export async function runScript(code, context) {
