...
import { getConnectorWorld, hasLockLoop, solveDragWithLoops, debugWorstJoint } from '@/assembly/connectorSnap';
...
import { mateBridge, type MateAnimRequest } from '@/bridge/mateBridge';
